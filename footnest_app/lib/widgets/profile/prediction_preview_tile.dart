...
class PredictionPreviewTile extends StatefulWidget {
  ...
  @override
  State<PredictionPreviewTile> createState() =>
      _PredictionPreviewTileState();

}



class _PredictionPreviewTileState
    extends State<PredictionPreviewTile> {
